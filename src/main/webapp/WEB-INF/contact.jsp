	...
	<div class="container">
		<div class="flex-w flex-tr">
			<div
				...
				<form>
					<h4 class="mtext-105 cl2 txt-center p-b-30">Envoyez Nous Un
						Message</h4>
					<div class="bor8 m-b-20 how-pos4-parent">
						<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30"
							type="text" name="email" placeholder="Votre adresse email">
					...
					<div class="bor8 m-b-30">
						<textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25"
							name="msg" placeholder="Comment pouvons-nous vous aider ?"></textarea>
					</div>
			...
			<div
				...
				<div class="flex-w w-full p-b-42">
					...
					<div class="size-212 p-t-2">
						<span class="mtext-110 cl2"> Addresse</span><span
							class="mtext-110 cl2">se</span>
						<p class="stext-115 cl6 size-213 p-t-18">
							iForm ESTIA II<br> 64210 BIDART
						</p>
					</div>
				</div>
				<div class="flex-w w-full">
					...
					<div class="size-212 p-t-2">
						<span class="mtext-110 cl2">Support des ventes</span>
