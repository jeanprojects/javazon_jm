...
<body class="animsition">
								...
								<div class="form-group">
									<input type="checkbox" id="checkboxRegister"> 
									   <label for="checkboxRegister" class="white-text form-check-label">
									      Accepter les <a href="#" class="green-text font-weight-bold" data-toggle="modal" data-target="#myModal"> Conditions générales</a>
									</label>
								</div>
							</form>
						</div>
									...
									<div class="cols-sm-10">
										<div class="input-group">
											<span class="input-group-addon">
											 ...
											 </span> <input  type="text"  class="form-control"  name="emailLogin"  id="emailLogin"  placeholder="Entrer votre Email" />
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="cols-sm-10">
										<div class="input-group">
											<span class="input-group-addon">
											   <i class="fa fa-lock fa-lg" aria-hidden="true"></i></span> 
											      <input  type="password"  class="form-control"  name="passwordLogin"  id="passwordLogin"  placeholder="Entrer un mot de passe" />
										</div>
									</div>
								</div>
							</form>
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						...
						<div class="header-cart-item-txt p-t-8">
							...
							<span class="header-cart-item-info couleurElementCart"> 1 x 19.00€ </span>
						</div>
					</li>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						...
						<div class="header-cart-item-txt p-t-8">
							...
							<span class="header-cart-item-info couleurElementCart"> 1 x 39.00€ </span>
						</div>
					</li>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						...
						<div class="header-cart-item-txt p-t-8">
							...
							<span class="header-cart-item-info couleurElementCart"> 1 x 17.00€ </span>
						</div>
					</li>
				</ul>
	...
	function doLogin() {
		...
		//var mailLogin = document.querySelector("div.modal fade.modal-dialog.modal-content.modal-body.form-group.cols-sm-10.input-group input[name='#mailLogin']");
		//var passwordLogin = document.querySelector("div.modal fade.modal-dialog.modal-content.modal-body.form-group.cols-sm-10.input-groupinput input[name='passwordLogin']");
				
		var userdata = '{"username":'+emailLogin.value+',"password":'+passwordLogin.value+'}';
	...
	function loginByAjax(data) {
			...
			request.open("POST", "login_page", true);
