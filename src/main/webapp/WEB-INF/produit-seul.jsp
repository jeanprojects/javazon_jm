...
<body class="animsition">
			...
			<div class="col-md-6 col-lg-5 p-b-30">
				<div class="p-r-50 p-t-5 p-lr-0-lg">
					...
					<p class="stext-102 cl3 p-t-23">
						...
						ligula. Mauris consequat ornare feugiat.<br> Nulla eget sem
			...
			<div class="tab01">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li class="nav-item p-b-10"><a class="nav-link"
						data-toggle="tab" href="#information" role="tab">Informations
							supplémentaires</a></li>

					<li class="nav-item p-b-10"><a class="nav-link"
						data-toggle="tab" href="#reviews" role="tab">Commentaires</a></li>
				</ul>
							...
							<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
								<ul class="p-lr-28 p-lr-15-sm">
									<li class="flex-w flex-t p-b-7"><span
										class="stext-102 cl3 size-205"> Poids </span> <span
									...
									<li class="flex-w flex-t p-b-7"><span
										class="stext-102 cl3 size-205"> Matériaux </span> <span
										class="stext-102 cl6 size-206"> 70% coton </span></li>

									<li class="flex-w flex-t p-b-7"><span
										class="stext-102 cl3 size-205"> Couleur </span> <span
										class="stext-102 cl6 size-206"> Noir, Bleu, Gris, Vert,
											Rouge, Blanc </span></li>

									<li class="flex-w flex-t p-b-7"><span
										class="stext-102 cl3 size-205"> Taille </span> <span
						...
						<div class="row">
							<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
								<div class="p-b-30 m-lr-15-sm">
									...
									<div class="flex-w flex-t p-b-68">
										<div class="size-207">
											<div class="flex-w flex-sb-m p-b-17">
												<span class="mtext-107 cl2 p-r-20"> Nom du client </span> <span
									...
									<!-- Add review -->
									<form class="w-full">
										<h5 class="mtext-108 cl2 p-b-7">Ajouter un commentaire</h5>

										<p class="stext-102 cl6">Votre adresse email ne sera pas
											publiée. Les champs obligatoires sont marqué avec *</p>

										<div class="flex-w flex-m p-t-50 p-b-23">
											<span class="stext-102 cl3 m-r-16"> Note du produit </span> <span
										...
										<div class="row p-b-25">
											<div class="col-12 p-b-5">
												<label class="stext-102 cl3" for="review">Votre
													commentaire</label>
												<textarea
											...
											<div class="col-sm-6 p-b-5">
												<label class="stext-102 cl3" for="name">Nom</label> <input
	...
	<div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15">
		<span class="stext-107 cl6 p-lr-25"> Reférence : JAK-01 </span> <span
			class="stext-107 cl6 p-lr-25"> Categories : Veste, Homme </span>
	</div>
	</section>
