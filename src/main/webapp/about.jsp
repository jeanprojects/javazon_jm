	...
	<header class="header-v2">
	  ...
	  <div class="container-menu-desktop trans-03">
	    <div class="wrap-menu-desktop">
	      <nav class="limiter-menu-desktop p-l-45">
	        <!-- Logo desktop -->
	        <a href="#" class="logo"> <img src="images/logo_javazon.png" alt="IMG-LOGO"> </a>
	        <!-- Menu desktop -->
	        <div class="menu-desktop">
	          <ul class="main-menu">
	            <li class="active-menu"><a href="index.html">Accueil</a></li>
	            <li> <a href="produits.html">Catalogue</a> </li>
	            <li> <a data-toggle="modal" href="#exampleModal">Créer son compte</a> </li>
	            <li> <a href="about.html">S'identifier</a> </li>
	  ...
	  <div class="menu-mobile">
	    <ul class="main-menu-m">
	      ...
	      <li> <a href="panier.html" class="label1 rs1" data-label1="hot">Features</a> </li>
			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						...
						<a href="panier.html" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
							Check Out
						</a>
					</div>
				</div>
